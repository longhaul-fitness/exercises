...
from nodes import StrengthMusclesNode


def prepare_muscles_node_input(test_case: Dict[str, Any], model: str) -> Dict[str, Any]:
    """Prepare input data for StrengthMusclesNode."""
    return {
...
def run_strength_muscles_node(
    models: Optional[List[str]] = None,
    test_case_id: Optional[str] = None,
    data_path: Optional[str] = None,
) -> List[Dict[str, Any]]:
    """
    Run StrengthMusclesNode with specified models and test cases.
    ...
    return run_node_experiments(
        node_class=StrengthMusclesNode,
...
def main():
    """CLI interface for running the strength muscles node experiments."""
    import argparse

    parser = argparse.ArgumentParser(description="Run StrengthMusclesNode experiments")
    ...
    # Run the experiments
    results = run_strength_muscles_node(
    ...
    if args.output:
        ...
        filepath = save_json_results(
            results, models or DEFAULT_MODELS, "strength_muscles_node"
        )
