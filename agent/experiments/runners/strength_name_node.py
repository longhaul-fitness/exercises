...
from nodes import StrengthNameNode
...
def run_strength_name_node(
    models: Optional[List[str]] = None,
    test_case_id: Optional[str] = None,
    data_path: Optional[str] = None,
) -> List[Dict[str, Any]]:
    """
    Run StrengthNameNode with specified models and test cases.
...
def main():
    """CLI interface for running the strength name node experiments."""
    import argparse

    parser = argparse.ArgumentParser(description="Run StrengthNameNode experiments")
    ...
    # Run the experiments
    results = run_strength_name_node(
    ...
    if args.output:
        ...
        filepath = save_json_results(
            results, models or DEFAULT_MODELS, "strength_name_node"
        )
